        ...
        publications {
            register("maven", MavenPublication::class) {
                ...
                pom {
                    ...
                    description.set("jfix-zookeeper Basic primitives on top of zookeeper")
                    url.set("https://github.com/ru-fix/jfix-zookeeper")
                    licenses {
                        license {
                    ...
                    scm {
                        url.set("https://github.com/ru-fix/jfix-zookeeper")
                        connection.set("https://github.com/ru-fix/jfix-zookeeper.git")
                        developerConnection.set("https://github.com/ru-fix/jfix-zookeeper.git")
                    }
                }
            }
        }
